...
public class TransactionController {
   ...
   * @return ResponseEntity chứa ApiResult mang theo đối tượng TransactionResponse vừa tạo.
   */
  @PostMapping("/create")
   ...
   * @return ResponseEntity chứa ApiResult mang theo đối tượng TransactionResponse sau khi cập nhật.
   */
  @PutMapping("/{id}")
   ...
   * @return ResponseEntity chứa ApiResult trạng thái thành công với dữ liệu là Void.
   */
  @DeleteMapping("/{id}")
   ...
   * @return ResponseEntity chứa ApiResult mang theo danh sách (List) các TransactionResponse.
   */
